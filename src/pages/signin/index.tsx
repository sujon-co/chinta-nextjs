...
const SignIn: NextPage<Props> = () => {
    ...
    return (
        <>
            <Head>
                <title>Chinta Sthapatya - Login</title>
            </Head>
                        ...
                        <Form className="login-form needs-validation noValidate">
                            ...
                            <div className="form-floating mb-2">
                                <Field
                                    ...
                                    className={`form-control form-control-sm  ${touched.email && errors.email
                                            ? 'is-invalid'
                                            : ''
                                        }`}
                                />
                            ...
                            <div className="form-floating">
                                <Field
                                    ...
                                    type="password"
                                    id="password"
                                    className={`form-control form-control-sm  ${touched.password && errors.password
                                            ? 'is-invalid'
                                            : ''
                                        }`}
