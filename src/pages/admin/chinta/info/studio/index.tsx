...
const Studio = ({ studios }: IProps) => {
    ...
    const [studio, setStudio] =
        useState<IStudioWithImagePlaceholder>({} as IStudioWithImagePlaceholder);
                                    ...
                                    <div className="card-body p-0">
                                        ...
                                        <div className="card-text pb-2">
                                            <div className="social-icons">
                                                <a href={studio.socialLink?.instagram} target="_blank" rel="noopener noreferrer" className="social-icons-item">
                                                    <FaInstagram />
                                                </a>
                                                <a href={studio.socialLink?.linkedIn} target="_blank" rel="noopener noreferrer" className="social-icons-item">
                                                    <FaLinkedinIn />
                                                </a>
                                            </div>
                                        </div>
...
export const getServerSideProps: GetServerSideProps = async () => {
    ...
    const { data: { data } } = await axios.get<{ data: IStudio[] }>('/info/studios');
